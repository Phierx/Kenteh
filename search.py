...
# Load ResNet model and prepare feature extractor (matching `vectorprocessor.py`)
resnet = models.resnet50(weights=models.ResNet50_Weights.DEFAULT)
resnet.eval()
feature_extractor = torch.nn.Sequential(*list(resnet.children())[:-1])

# Image preprocessing (identical to vectorprocessor.py)
...
def extract_vector(img_path):
    ...
    # Normalize to match saved vectors
...
def upload_image():
    ...
    # Iterate through stored feature vectors
